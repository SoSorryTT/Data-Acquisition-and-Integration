...
class TestDefaultController(BaseTestCase):
    ...
    def test_controller_get_basin_annual_rainfall(self):
        ...
        response = self.client.open(
            '/rain-api/v3/basins/{basinId}/annualRainfalls/{year}'.format(basin_id=56, year=56),
            method='GET')
    ...
    def test_controller_get_basin_details(self):
        ...
        """
        response = self.client.open(
            '/rain-api/v3/basins/{basinId}'.format(basin_id=56),
            method='GET')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_controller_get_basin_monthly_average(self):
        ...
        """
        response = self.client.open(
            '/rain-api/v3/basins/{basinId}/monthlyAverage'.format(basin_id=56),
            method='GET')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_controller_get_station_details(self):
        ...
        """
        response = self.client.open(
            '/rain-api/v3/stations/{stationId}'.format(station_id=56),
            method='GET')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_controller_get_stations_in_basin(self):
        ...
        """
        response = self.client.open(
            '/rain-api/v3/stationsInBasin/{basinId}'.format(basin_id=56),
            method='GET')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
