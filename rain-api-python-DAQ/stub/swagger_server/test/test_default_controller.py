...
class TestDefaultController(BaseTestCase):
    ...
    def test_controller_get_basin_year_details(self):
        """Test case for controller_get_basin_year_details

        Returns complete details of the rainfalls in specified basin year
        """
        response = self.client.open(
